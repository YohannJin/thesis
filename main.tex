...
\newcommand{\titelderarbeit}{Study Control Method for guaranteed Control of human-robot Interaction with Simulaiton Verification in ROS}
\newcommand{\nummerderarbeit}{M1000} % Or: Mxxx
\newcommand{\artderarbeit}{Master's Thesis} % Or: Master's Thesis
\newcommand{\student}{Yuhan Jin}
\newcommand{\studentgrad}{B.Sc.} % Or: B.Sc.
\newcommand{\betreuer}{Sean Kille}
\newcommand{\betreuergrad}{M.Sc.}
\newcommand{\ausgabe}{2th August 2022}
\newcommand{\abgabe}{2th August 2022}
\newcommand{\sperrvermerkUnternehmen}{Xxxx Gmbh}
\newcommand{\sperrvermerkDatum}{10th January 2025} % 5 years after submission
...
\begin{document}
	...
	\cleardoublepage
	\include{02_chapter/02_Problem definition.tex}
	\cleardoublepage 
	\include{02_chapter/03_Fundamentals.tex}
	\cleardoublepage 
	\include{02_chapter/04_Implementation of RRT-based motion planning with optimization.tex}
	\cleardoublepage 
	\include{02_chapter/05_Simulation and Validation.tex}
	\cleardoublepage 
	\include{02_chapter/06_Conclusion and Outlook.tex}
	\cleardoublepage 
	%% ---------------------------------------------------------------------------
	%% Appendices
	%% ---------------------------------------------------------------------------
